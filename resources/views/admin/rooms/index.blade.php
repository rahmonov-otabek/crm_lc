                    ...
                    <div class="page-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto text-end float-end ms-auto download-grp">
                                <a href="{{ route('get_rooms') }}" class="btn btn-outline-primary me-2"><i class="fas fa-download"></i>
                                    Yuklab olish</a>
                                <a href="{{ route('admin.rooms.create') }}" class="btn btn-primary"><i
                            ...
                            <tbody>
                                @foreach ($rooms as $room)
                                    <tr>
                                        <td>{{ $room->id }}</td>
                                        <td> 
                                             <a href="teacher-details.html">{{ $room->name }}</a> 
                                        </td> 
                                        <td class="text-end">
                                            <div class="actions"> 
                                                <form method="POST" action="{{ route('admin.rooms.destroy', $room->id) }}" onclick="return confirm('O`chirishni xohlaysimi?')">
                                                    @csrf
                                                    @method('DELETE')
