                            ...
                            <tbody>
                                @foreach ($departments as $department)
                                    <tr>
                                        <td>{{ $department->id }}</td>
                                        <td> 
                                             <a href="teacher-details.html">{{ $department->name }}</a> 
                                        </td> 
                                        <td class="text-end">
                                            <div class="actions"> 
                                                <form method="POST" action="{{ route('admin.departments.destroy', $department->id) }}" onclick="return confirm('O`chirishni xohlaysimi?')">
                                                    @csrf
                                                    @method('DELETE')
