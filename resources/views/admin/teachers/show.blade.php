        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-sub-header">
                    <h3 class="page-title">Ustozning ma'lumotlari</h3> 
                </div>
            </div>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-1">
                    <form method="POST" action="{{ route('admin.teachers.destroy', $teacher->id) }}" onclick="return confirm('O`chirishni xohlaysimi?')">
                        @csrf
                        @method('DELETE')
