...
@section('content')
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Kurs qo'shish</h3>
            </div>
        </div>
    </div>
    @if ($errors->any())
                ...
                <div class="card-body">
                    <form action="{{ route('admin.courses.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-1">
                                <a href="{{ route('admin.courses.index') }}"><button type="button"
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input type="text" class="form-control" name="salary" placeholder="Narxini kiriting"
